<template>
  <div>
    ...
    <canvas id="civara-guide-canvas" class="pattern" :width="width" :height="height"> </canvas>

    <canvas id="civara-panels-1-2-3-canvas" class="pattern" :width="width" :height="height">
    </canvas>

    <canvas id="civara-panels-4-5-6-canvas" class="pattern" :width="width" :height="height">
    </canvas>

    <canvas id="civara-panels-7-8-9-canvas" class="pattern" :width="width" :height="height">
    </canvas>
  </div>
</template>
